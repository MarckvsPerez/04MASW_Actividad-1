        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body text-center">
              ...
              <a class="btn btn-primary" href="views/platforms/list.php"
                >Listado de plataformas</a
              >
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card">
            <div class="card-body text-center">
              ...
              <a class="btn btn-primary" href="views/languages/list.php"
                >Listado de idiomas</a
              >
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card">
            <div class="card-body text-center">
              ...
              <a class="btn btn-primary" href="#">Listado de directores/as</a>
            </div>
          </div>
        </div>
        <div class="col-md-4">
