...
<body>
    ...
    <div class="container">
        <?php
        $idLanguage = $_GET['id'];
        $languageObject = getLanguage($idLanguage);
                ...
                <div class="col-12">
                    <form name="edit_language" action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="languageCode" name="languageCode" type="text" placeholder="Introduce el código ISO del idioma" class="form-control" required value="<?php if (isset($languageObject)) echo $languageObject->getIso(); ?>" />
