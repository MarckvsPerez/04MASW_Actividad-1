                ...
                ?>
                    <div class="row row-cols-1 row-cols-md-3 g-4">
                        ...
                        foreach ($serieList as $serie) {
                            ...
                            $director = getDirector($serie->getDirector());
                            $directorName = $director ? $director->getName() : 'Desconocido';
                            $directorSurname = $director ? $director->getSurname() : 'Desconocido';

                            $audio = getLanguage($serie->getAudio());
                            $audioName = $audio ? $audio->getName() : 'Desconocido';

                            $subtitle = getLanguage($serie->getSubtitle());
                            $subtitleName = $subtitle ? $subtitle->getName() : 'Desconocido';
                        ?>
                            <div class="col">
                                <div class="card h-100 shadow-sm">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text">Actor: <?php echo $actorName; ?> <?php echo $actorSurname; ?></p>

                                        <hr>
                                        <p class="card-text">Audio: <?php echo $audioName; ?></p>
                                        <p class="card-text">Subtitulo: <?php echo $subtitleName; ?></p>

                                        <div class="btn" role="group" aria-label="Serie">
                                            <a class="btn btn-success mx-2" href="edit.php?id=<?php echo $serie->getId(); ?>">Editar</a>
